<main class="contenedor seccion">
        ...
        <?php if($mensaje){?>
               <?php echo "<p class='alerta exito'>" . $mensaje ."</p>"; ?>
        <?php }?>
        ...
        <form class="formulario" method="POST">
            ...
            <fieldset>
                ...
                <div class="forma-contacto">
                    ...
                    <input  type="radio" value="telefono" id="contactar-telefono" name="contacto[medio]">

                    <label for="contactar-email">E-mail</label>
                    <input  type="radio" value="email" id="contactar-email" name="contacto[medio]" require>
                </div>
